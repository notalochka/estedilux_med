...
export const eventCategories: EventCategory[] = [
  {
    ...
    title: {
      ...
      tr: 'Estetik Tıp ve Dermatoloji',
      uk: 'Естетична медицина та дерматологія',
    },
    description: {
      ...
      tr: 'Estedilux Med, estetik tıp, dermatoloji ve modern kozmetoloji teknikleri konusunda kapsamlı programlar sunmaktadır. Programlarımız uluslararası standartlar göz önünde bulundurularak tasarlanmış olup, doktorlara ileri teknikler ve uygulamalara erişim sağlamaktadır. Dünya çapında önde gelen tıp merkezlerinde, katılımcıların deneyimli uzmanların rehberliğinde enjeksiyon teknikleri, donanım teknolojileri ve modern tedavi protokollerini inceleme fırsatı bulduğu pratik kurslar düzenliyoruz. Tüm programlar teorik hazırlık ve pratik oturumlar içerir, bu da doktorların sadece yeni tekniklerde ustalaşmasına değil, aynı zamanda estetik tıpta çeşitli yöntemlerin güvenli uygulanmasının ilkelerini anlamasına olanak tanır.',
      uk: 'Estedilux Med пропонує комплексні програми з естетичної медицини, дерматології та сучасних косметологічних методик. Наші програми розроблені з урахуванням міжнародних стандартів і забезпечують лікарям доступ до передових технік та практик. Ми організовуємо практичні курси в провідних медичних центрах світу, де учасники отримують можливість вивчити ін\'єкційні методики, апаратні технології та сучасні протоколи лікування під керівництвом досвідчених спеціалістів. Всі програми включають теоретичну підготовку та практичні заняття, що дозволяє лікарям не лише опанувати нові техніки, але й зрозуміти принципи безпечного застосування різних методик в естетичній медицині.',
    },
    subcategories: [
      {
  ...
  },
  {
    ...
    title: {
      ...
      tr: 'Anatomi ve Kadavra Programları',
      uk: 'Анатомія та Cadaver програми',
    },
    description: {
      ...
      tr: 'Estedilux Med\'den anatomi ve kadavra programları, pratik diseksiyon programları aracılığıyla insan anatomisinin derinlemesine incelenmesi için benzersiz bir fırsat sunmaktadır. Doktorların gerçek kadavralar üzerinde yüz, boyun ve diğer anatomik bölgeleri inceleyebileceği dünya standartlarında donatılmış üniversite anatomi laboratuvarlarında kurslar düzenliyoruz. Programlarımız, deneyimli anatomistler ve cerrahların rehberliğinde enjeksiyon anatomisi, cerrahi anatomi çalışması ve pratik diseksiyonları içermektedir. Ayrıca bireysel VIP diseksiyonlar ve üniversitelerle müzakereler, laboratuvar kiralama, eğitmen sağlama ve tüm gerekli malzemeler dahil olmak üzere anahtar teslimi kadavra kursu organizasyonu sunuyoruz.',
      uk: 'Програми з анатомії та cadaver курсів від Estedilux Med надають унікальну можливість поглибленого вивчення анатомії людини через практичні диссекційні програми. Ми організовуємо курси в університетських анатомічних лабораторіях, оснащених за світовими стандартами, де лікарі можуть вивчати анатомію обличчя, шиї та інших областей на реальних кадаверах. Наші програми включають вивчення ін\'єкційної анатомії, хірургічної анатомії та практичні диссекції під керівництвом досвідчених анатомів та хірургів. Ми також пропонуємо індивідуальні VIP-диссекції та повну організацію cadaver курсів під ключ, включаючи переговори з університетами, оренду лабораторій, надання викладачів та всіх необхідних матеріалів.',
    },
    subcategories: [
